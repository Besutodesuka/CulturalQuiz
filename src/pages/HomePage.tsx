...
function HomePage() {
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen dark:bg-gray-800 text-center px-4">
      ...
      <div className="bg-white p-8 sm:p-12 rounded-xl shadow-lg max-w-md w-full">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
          Welcome to Story based cultural test!
        </h1>

        {/* Description */}
        <p className="text-gray-600 mb-8 text-base sm:text-lg">
          Ready to challenge yourself? Click the button below to start the journey.
        </p>
        ...
        >
          <button
            className="
              bg-purple-600/80 hover:bg-purple-600 // Background and hover state
